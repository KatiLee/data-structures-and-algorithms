...
const typeNum = (arr) => {
  // Solution code here...
  let numOnlyArray = arr.filter(Number);
  return numOnlyArray;
};
...
Write a function named notInFirstArray that, given two arrays as input, uses filter to return an array of all the elements in the 
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let selectiveArray = arr.filter(nums => !forbiddenValues.includes(nums));
...
Write a function named getBaseStatGreaterThan that, given the snorlaxData, below, and an integer as input, uses filter to return 
