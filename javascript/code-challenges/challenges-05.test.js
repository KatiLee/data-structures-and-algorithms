...
const addValues = (arr) => {
  // Solution code here...
  let addedArray = arr.reduce((accumulator, value) => 
    accumulator + value, 0);
    return addedArray;
  };
...
const addPurchases = (arr) => {
  ...
  let total = arr.reduce((accumulator, value) => {
    return (accumulator + value.purchasePrice)}, 0);
  return total;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let lengthArray = arr.reduce((accumulator, value) => {
...
const returnNames = (arr) => {
  // Solution code here...
  let namesArray = arr.reduce((accumulator, value) => {
...
const reversedString = (str) => {
  // Solution code here...
  let backwardsArray = str.split('');
  return backwardsArray.reduce((accumulator, value) => {
...
const countNumberOfChildren = (arr) => {
  ...
  let total = arr.reduce((accumulator, value) => {
    ...
    {kidCount = value.children.length}
    return (accumulator + kidCount);
  }, 0);
  return total;
};
